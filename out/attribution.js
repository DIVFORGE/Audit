...
exports.getActiveAITools = getActiveAITools;
exports.classifyEdit = classifyEdit;
 ...
 */
function classifyEdit(shape, activeTools) {
    const looksLikeAcceptedSuggestion = shape.isSingleContiguousInsert &&
